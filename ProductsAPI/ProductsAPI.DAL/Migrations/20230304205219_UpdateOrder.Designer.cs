...
namespace ProductsAPI.DAL.Migrations
{
    ...
    [Migration("20230304205219_UpdateOrder")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductsAPI.DAL.Models.Account.ApiRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            ConcurrencyStamp = "22ed2af6-919b-48d7-9259-f2af7b7b90f4",
                            Name = "Admin",
                        ...
                        {
                            Id = 2,
                            ConcurrencyStamp = "4d77cea5-d618-4711-b0ff-3520d1f65401",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("ProductsAPI.DAL.Models.Images.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductsAPI.DAL.Models.Orders.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductsAPI.DAL.Models.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductsAPI.DAL.Models.Orders.OrderItem", b =>
                {
                    b.HasOne("ProductsAPI.DAL.Models.Orders.Order", "Order")
                        .WithMany("OrderItems")
